...
• Rain detection system to prevent unnecessary watering

• Water tank level monitoring to avoid dry running of pumps

• PIR sensor-based intrusion detection for animal protection

• Manual & automatic pump control through cloud platform
